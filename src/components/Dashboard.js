...
const styles = {
  ...
  input: {
    ...
    border: '1px solid #ddd', fontSize: '14px', minWidth: '0'
  },
  aliasInput: {
  ...
  urlCard: {
    ...
    borderBottom: '1px solid #f0f0f0', flexWrap: 'wrap', gap: '8px'
  },
  urlInfo: { flex: '1 1 200px', minWidth: '0' },
  shortUrl: {
    color: '#4f46e5', fontWeight: 'bold',
    fontSize: 'clamp(12px, 3vw, 14px)', wordBreak: 'break-all'
  },
  originalUrl: { color: '#999', fontSize: '12px', margin: '4px 0 0 0', wordBreak: 'break-all' },
